                        ...
                        <tr style="border-bottom:1px solid var(--color-border); vertical-align:middle;">
                            ...
                            <td style="padding:12px 20px; text-align:right;">
                                <div style="display:inline-flex; gap:6px;">
                                    ...
                                    <a href="delete.php?id=<?= $t['id'] ?>&csrf_token=<?= csrf_token() ?>" onclick="return confirm('Permanently delete this testimonial?');" class="btn btn-secondary" style="padding:4px 10px; font-size:11px; border-radius:var(--radius-sm); background:#f03e3e; color:#fff; text-decoration:none;"><i class="fas fa-trash"></i> Delete</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
