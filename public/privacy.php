...
/**
 * ==========================================================================
 * public/privacy.php — Privacy Policy Page
 * ==========================================================================
 * Standard privacy disclosure statement regarding data collection, cookies,
 * user credentials protection, and secure SSLCommerz payment encryption.
 * ==========================================================================
 */
...
$cmsPage = null;
try {
    $stmt = $pdo->prepare("SELECT * FROM cms_pages WHERE page_key = 'privacy' LIMIT 1");
    $stmt->execute();
    $cmsPage = $stmt->fetch();
} catch (PDOException $e) {
    error_log('[storefront/privacy] ' . $e->getMessage());
}
...
<section class="legal-hero">
    <div class="container">
        ...
        <p>Your privacy matters to us. Learn how we handle your personal information securely.</p>
    </div>
</section>
...
<section class="legal-section">
    <div class="container">
        <div class="legal-wrapper">
            ...
            <?= $cmsPage ? $cmsPage['content'] : 'No privacy policy content available.' ?>
        </div>
    </div>
</section>
