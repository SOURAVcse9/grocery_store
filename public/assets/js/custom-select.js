/**
 * custom-select.js — GroCo Accessible Custom Select Component (Progressive Enhancement)
 * 
 * Provides an accessible, production-ready custom select experience while
 * maintaining 100% synchronization with the underlying native <select>.
 * Fully supports keyboard navigation (Arrows, Enter, Space, Escape, Tab),
 * ARIA roles, click-outside handling, and instant Dark/Light theme switching.
 */
(function(window, document) {
  ...
  function initCustomSelect(selectEl) {
    ...
    // Hide native select from mouse/visual view while preserving accessibility & form submission
    ...
    arrowIcon.innerHTML = '&#9662;'; // Downward triangle
